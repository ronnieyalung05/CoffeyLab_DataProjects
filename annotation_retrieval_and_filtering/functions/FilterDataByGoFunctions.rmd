...
# GO ID filter
# -------------------------------
filter_samples_by_go <- function(protein_df) {
...
# -------------------------------
filter_samples_by_go_names <- function(protein_df) {
...
# -------------------------------
filter_samples_by_go_names_strict <- function(protein_df) {
...
# -------------------------------
filter_samples_by_go_combined <- function(protein_df) {
...
# -------------------------------
filter_samples_by_go_combined_strict <- function(protein_df) {
  user_go_ids <- readline(prompt = "Enter GO IDs to filter for (comma-separated, or leave blank to skip): ")
  go_ids <- if (nzchar(user_go_ids)) str_trim(unlist(str_split(user_go_ids, ","))) else character(0)
...
run_go_filter <- function(protein_df) {
  ...
  filters <- list(
    list(name = "filter_samples_by_go", 
         desc = "Filter by GO IDs"),
    list(name = "filter_samples_by_go_names", 
         desc = "Filter by GO names (contains/fuzzy)"),
    list(name = "filter_samples_by_go_names_strict", 
         desc = "Filter by GO names (exact match)"),
    list(name = "filter_samples_by_go_combined", 
         desc = "Filter by GO IDs and GO names (contains/fuzzy)"),
    list(name = "filter_samples_by_go_combined_strict", 
...
# -------------------------------
# Example usage:
# filtered_samples <- run_go_filter(sample_data_with_go)